 ...
 */
package org.linjie.jleaven.ddd.support.infrastructure.repository.jpa;

import org.linjie.jleaven.ddd.support.domain.AggregateIdImpl;
import org.linjie.jleaven.ddd.support.domain.BaseAggregateRoot;
...
public abstract class GenericJpaRepository<A extends BaseAggregateRoot> {
    ...
    public A load(AggregateIdImpl id) {
    ...
    public void delete(AggregateIdImpl id){
		A entity = load(id);
		//just flag
